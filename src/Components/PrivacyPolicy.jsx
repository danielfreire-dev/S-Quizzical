			...
			<div id="privacy-policy">
				<div>
					...
					<p>
						...
						https://quizzicall-bydainelli.netlify.app/ (the “Site”).
					</p>
					...
					<ul>
						<li>
							...
							the Site, https://www.allaboutcookies.org.
						</li>
						<li>
					...
					<p>
						...
						https://policies.google.com/privacy. You can also opt-out of Google
					...
					<h2>Your Rights</h2>
					<p>
						If you are a resident in certain countries, including those that
						fall under the scope of the European General Data Protection
						Regulation (GDPR), data protection laws give you rights with respect
						to your Personal Information, subject to any exemptions provided by
						the law, including the rights to:
					</p>
					<ul>
						...
						<li>Withdraw any consent you provide to us.</li>
					</ul>
					<p>
						To make such a request, please use the Contact Information below. At
						our discretion, we may deny your request if it is excessively
						repetitive or manifestly unfounded. If we deny your request, we will
						tell you why unless this would involve disclosing Personal
						Information about another person.
					</p>
					<h2>Exercising Your Rights</h2>
					<p>
						In your request, attach any relevant supporting documents and
						include the following information:
					</p>
					<ul>
						<li>Your full legal name.</li>
						<li>
							Your relationship (if any) with the individual(s) whose Personal
							Information you are requesting to access, correct, or delete.
						</li>
					</ul>
					<p>We will respond to your request within 30 days.</p>
					<h2>Contact Information</h2>
					<p>
						To ask a question or make a request about your Personal Information,
						contact us at:
					</p>
					<p>
						<a href="https://danielfreire.pages.dev/contact">
							danielfreire.pages.dev/
						</a>
					</p>
				</div>
			</div>
