	...
	return (
		<div id="privacy-policy" className={`${displayStyle}`} lazyload="on">
			<div>
				...
				<h2>Your Rights</h2>
				<p>
					If you are a resident in certain countries, including those that fall
					...
					Personal Information, subject to any exemptions provided by the law,
				...
				<p>
					...
					tell you why unless this would involve disclosing Personal Information
					about another person.
				</p>
				<h2>Exercising Your Rights</h2>
				<p>
					In your request, attach any relevant supporting documents and include
				...
				<p>
					<a href="mailto:info@quizapp.com">info@quizapp.com</a>
				</p>
			</div>
		</div>
	);
